...
<div class="flex flex-col gap-6">
    <x-auth-header title="Iniciar sesión" description="Ingresa tu correo y contraseña para acceder al sistema" />
    ...
    <form wire:submit="login" class="flex flex-col gap-6">
        ...
        <!-- Remember Me -->
        <flux:checkbox wire:model="remember" label="Mantener sesión iniciada" />
